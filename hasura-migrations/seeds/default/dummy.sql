...
INSERT INTO "public"."questions"("id", "board_id", "data", "type")
VALUES (18,18, '{"question" : "Evaluate your knowldege in Fastify:"}', 'question18');

INSERT INTO "public"."questions"("id", "board_id", "data", "type")
VALUES (19,19, '{"question" : "Evaluate your knowldege in Jest:"}', 'question19');

INSERT INTO "public"."questions"("id", "board_id", "data", "type")
VALUES (20,20, '{"question" : "Evaluate your knowldege in SOLID Principles:"}', 'question20');

INSERT INTO "public"."questions"("id", "board_id", "data", "type")
VALUES (21,21, '{"question" : "Evaluate your knowldege in REST APIs:"}', 'question21');

INSERT INTO "public"."questions"("id", "board_id", "data", "type")
VALUES (22,22, '{"question" : "Evaluate your knowldege in C/C++:"}', 'question22');
...
INSERT INTO "public"."answers"("id","board_id","user_id","question_id","score","data")
VALUES(19,19,19,19,10,'{"option1":"0-Zero",
"option2":"1-I can read it and orient myself in a file / project",
"opsion3":"2-I can work on a file / project",
"option4":"3-I can use it even in more complex projects", 
"option5":"4-I have advanced knowledge, I could teach it to someone else",
...
INSERT INTO "public"."answers"("id","board_id","user_id","question_id","score","data")
VALUES(20,20,20,20,10,'{"option1":"0-Zero",
"option2":"1-I can read it and orient myself in a file / project",
"opsion3":"2-I can work on a file / project",
"option4":"3-I can use it even in more complex projects", 
"option5":"4-I have advanced knowledge, I could teach it to someone else",
...
INSERT INTO "public"."answers"("id","board_id","user_id","question_id","score","data")
VALUES(21,21,21,21,10,'{"option1":"0-Zero",
"option2":"1-I can read it and orient myself in a file / project",
"opsion3":"2-I can work on a file / project",
"option4":"3-I can use it even in more complex projects", 
"option5":"4-I have advanced knowledge, I could teach it to someone else",
...
INSERT INTO "public"."answers"("id","board_id","user_id","question_id","score","data")
VALUES(22,22,22,22,10,'{"option1":"0-Zero",
"option2":"1-I can read it and orient myself in a file / project",
"opsion3":"2-I can work on a file / project",
"option4":"3-I can use it even in more complex projects", 
"option5":"4-I have advanced knowledge, I could teach it to someone else",
